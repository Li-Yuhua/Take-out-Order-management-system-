<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xiadanjilu_updt.aspx.cs" Inherits="xiadanjilu_updt" %>
		...
		<form id="Form1" method="post" runat="server">
			<br />
			   <table width="98%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">
				<tr bgColor="#f1f8f5">
					<td colSpan="2">
						<div align="center">modifyPlace an order记录</div>
					</td>
				</tr>
				...
				<tr><td><FONT face='宋体'>Amount of money:</FONT></td><td width='79%'><asp:textbox id='jine' runat='server' style='border:solid 1px #000000; color:#666666'></asp:textbox></td></tr>
