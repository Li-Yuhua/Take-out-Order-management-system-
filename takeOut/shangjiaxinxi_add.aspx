<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shangjiaxinxi_add.aspx.cs" Inherits="shangjiaxinxi_add" %>
		...
		<form id="Form1" method="post" runat="server">
			<br />
			   <table width="98%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">
				<tr bgColor="#f1f8f5">
					<td colSpan="2">
						<div align="center">Add toMerchant information</div>
					</td>
				</tr>
