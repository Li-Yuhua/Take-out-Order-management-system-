                        ...
                        <tr>
                            <td width="79%">
                                &nbsp;<asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                    ...
                                    <PagerStyle NextPageText="Previous page" PrevPageText="next page" />
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="addtime" HeaderText="Adding time"></asp:BoundColumn>
                                        <asp:TemplateColumn HeaderText="delete">
                                            <ItemTemplate>
                                                <a href='delid.aspx?delid=<%#DataBinder.Eval(Container.DataItem, "id") %>&tablename=allusers&npage=listuser.aspx'
                                                    onclick="return confirm('Determine要modify？')">delete</a>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                    </Columns>
                                </asp:DataGrid></td>
