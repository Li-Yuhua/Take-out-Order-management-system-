<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xiadanjiluadd.aspx.cs" Inherits="xiadanjiluadd" %>
	...
	<tr>
		<td><table id="Table2" width="978" height="785" border="0" cellpadding="0" cellspacing="0">
          <tr>
                ...
                <td height="785" valign="top"><table id="Table13" width="758" height="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="758" height="42" background="qtimages/1_02_02_02_01.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="5%">&nbsp;</td>
                        <td width="95%" class="STYLE2"><strong>Place an order记录</strong></td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
			...
			<tr><td><FONT face='宋体'>Purchase quantity:</FONT></td><td width='79%'><asp:TextBox ID='goumaishuliang' runat='server' style='border:solid 1px #000000; color:#666666'></asp:TextBox>*<asp:RequiredFieldValidator ID="RequiredFieldValidatorgoumaishuliang" runat="server" ControlToValidate="goumaishuliang" ErrorMessage="Must fill"></asp:RequiredFieldValidator> Required digital <asp:RegularExpressionValidator ID="gsyzgoumaishuliang" runat="server" ControlToValidate="goumaishuliang" ErrorMessage="必需数字" ValidationExpression="^(\+|-)?(0|[1-9]\d*)(\.\d*[1-9])?$"></asp:RegularExpressionValidator> </td></tr>
			<tr><td><FONT face='宋体'>Amount of money:</FONT></td><td width='79%'><asp:TextBox ID='jine' runat='server' style='border:solid 1px #000000; color:#666666;background-color:#CCCCCC' ReadOnly='true'></asp:TextBox>&nbsp;This item does not need to be filled in. It will be calculated automatically</td></tr>
