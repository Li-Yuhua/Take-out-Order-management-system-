                      ...
                      <tr>
                        <td height="119" colspan="2" align="center"><table width="91%" height="81" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td >System Author：xxxxxx</td>
                            </tr>
                            <tr>
                              <td width="36" height="22" align="center"><img src="images/hsg6.gif"></td>
                              <td ><p>Guidance teacher：xxxxx<a href="yhzhgl.aspx" target="mainFrame"></a></p>
                                </td>
                            </tr>
                            <tr>
                              <td width="36" height="22" align="center"><img src="images/hsg7.gif"></td>
                              <td ><a href="mod.aspx" target="mainFrame">Your school：xxxxx</a></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
              ...
              <tr onClick="show('1')" style="cursor:pointer;">
                <td width="184"  background="images/hsg4.gif"><table width="100%" height="26" border="0" cellpadding="0" cellspacing="0">
                   <tr>
                      ...
                      <td width="86%" height="25"><span class="STYLE3"><strong>Personal data management</strong></span></td>
                    </tr>
                </table></td>
              </tr>
              <tr>
				...
				<table width="91%" border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
					 <td width="36" height="22" align="center"><img src="images/hsg5.gif"></td>
					  <td ><a href="shangjiaxinxi_updt2.aspx" target="mainFrame">Personal data management</a></td>
					</tr>
				  </table>
				 </td>
              </tr>
              ...
              <tr onClick="show('2')" style="cursor:pointer;">
                <td width="184" background="images/hsg4.gif"><table width="100%" height="26" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="86%"><span class="STYLE3"><strong>Dishes informationAdministration</strong></span></td>
                    </tr>
                </table></td>
              </tr>
              <tr>
                <td width="184"  style="display:none"  id="show2"><table width="91%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="36" height="22" align="center"><img src="images/hsg5.gif"></td>
                      <td ><a href="caipinxinxi_add.aspx" target="mainFrame">Dishes informationAdd to</a></td>
                    </tr>
                    <tr>
                      <td width="36" height="22" align="center"><img src="images/hsg5.gif"></td>
                      <td ><a href="caipinxinxi_list2.aspx" target="mainFrame">Dishes informationAdministration</a></td>
                    </tr>
                </table></td>
              </tr>
            ...
            <td><table id="Table5" width="184" border="0" cellpadding="0" cellspacing="0">
              <tr onClick="show('3')" style="cursor:pointer;">
                <td width="184" background="images/hsg4.gif"><table width="100%" height="26" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="14%"  height="26" align="center" valign="bottom">&nbsp;</td>
                      <td width="86%"><span class="STYLE3"><strong>Order information management</strong></span></td>
                    </tr>
                </table></td>
              </tr>
              <tr>
                <td width="184"   style="display:none"  id="show3"><table width="91%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="36" height="22" align="center"><img src="images/hsg5.gif"></td>
                      <td ><a href="xiadanjilu_list3.aspx" target="mainFrame">Order information management</a></td>
                    </tr>
