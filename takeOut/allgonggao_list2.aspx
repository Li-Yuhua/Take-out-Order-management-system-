            ...
            <tbody>
                ...
                NextPageText="next page" PrevPageText="Previous page" />
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="modify">
                                	<ItemTemplate>
                                    	<a href='delgg.aspx?delid=<%#DataBinder.Eval(Container.DataItem, "id") %>&tablename=allgonggao&npage=allgonggao_list2.aspx&lb=<%=lbtxt %>' onclick="return confirm('Determine要modify？')">modify</a>
                               		</ItemTemplate>
								<HeaderStyle Width="50px" />
                                </asp:TemplateColumn>
